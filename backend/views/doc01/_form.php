...
<div class="doc01-form">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="row">  
                ...
                <div class="col-sm-5"><?= $form->field($model, 'Fname_th')->textInput(['maxlength' => true])?></div>
                <div class="col-sm-5"><?= $form->field($model, 'Lname_th')->textInput(['maxlength' => true]) ?></div>
                <div class="col-md-2"><?= $form->field($model, 'title_name_en_id')->dropDownList($model->getttllisten()) ?></div>
                <div class="col-md-5"><?= $form->field($model, 'Fname_en')->textInput(['maxlength' => true]) ?></div>
                <div class="col-md-5"><?= $form->field($model, 'Lname_en')->textInput(['maxlength' => true]) ?></div>
                ...
                <div class="col-md-8"><?= $form->field($model, 'Num_student')->textInput(['maxlength' => true]) ?></div>
                ...
                <div class="panel-body">                          
                    ...
                    <div class="row">
                        <div class="col-md-6" style="width: 500px;">
                              <?= $form->field($model, 'Detail_address')->textarea(['minlength' => true]) ?>
                        </div>
                    </div>                                                
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="width: 500px;">
                            <?= $form->field($model, 'Detail_address2')->textarea(['maxlength' => true]) ?>
                        </div>
                    </div>
                </div>
            </div>        
    ...
    <div class="row">
     <div class="col-md-6">
                  <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                          <div class="row">
                              <div class="col-md-6"><?= $form->field($model, 'Cell_phone_num')->textInput() ?></div>
                              <div class="col-md-6"><?= $form->field($model, 'Phone_num')->textInput() ?></div>
                  ...
                  <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6"><?= $form->field($model, 'Cell_phone_num3')->textInput() ?></div> 
    ...
    <div class="form-group">
        ...
        <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'บันทึกข้อมูล') : Yii::t('app', 'บันทึก'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-success']) ?>
    </div>
