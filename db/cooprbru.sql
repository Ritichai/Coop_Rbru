...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2016 at 07:52 AM
...
('นักศึกษา', '2', 1477384488),
('นักศึกษา', '3', 1477550280),
('นักศึกษา', '4', 1478445961),
('เจ้าหน้าที่', '1', 1477383839);
...
('loginToBackend', 2, 'ล็อกอินเข้าใช้งานส่วน backend', NULL, NULL, 1471270563, 1471270563),
('นักศึกษา', 1, 'ใช้สำหรับการจัดการข้อมูลในระดับนักเรียน', NULL, NULL, 1471270563, 1471270563),
('ผู้ใช้ทั่วไป', 1, 'จัดการข้อมูลผู้ใช้งาน', NULL, NULL, 1471270563, 1471270563),
('อาจารย์', 1, 'ใช้สำหรับการจัดการข้อมูลในระดับอาจารย์', NULL, NULL, 1471270563, 1471270563),
('เจ้าหน้าที่', 1, 'ใช้สำหรับการจัดการข้อมูลในระดับเจ้าหน้าที่สูงสุด', NULL, NULL, 1471270563, 1471270563),
('เจ้าหน้าที่อื่นๆ', 1, 'ใช้สำหรับการจัดการข้อมูลในระดับเจ้าหน้าที่', NULL, NULL, 1471270563, 1471270563);
...
('ผู้ใช้ทั่วไป', 'loginToBackend'),
('ผู้ใช้ทั่วไป', 'นักศึกษา'),
('ผู้ใช้ทั่วไป', 'อาจารย์'),
('เจ้าหน้าที่', 'เจ้าหน้าที่อื่นๆ'),
('เจ้าหน้าที่อื่นๆ', 'ผู้ใช้ทั่วไป');
...
('isAuthor', 'O:22:"common\\rbac\\AuthorRule":3:{s:4:"name";s:8:"isAuthor";s:9:"createdAt";i:1471270563;s:9:"updatedAt";i:1471270563;}', 1471270563, 1471270563);
...
CREATE TABLE `company` (
  ...
  `Detail_address` varchar(100) DEFAULT NULL COMMENT 'ลายละเอียดที่อยู่',
  `ID_province` int(6) NOT NULL,
  `ID_amphur` int(6) NOT NULL,
  `ID_district` int(6) NOT NULL,
  `company_web` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `Tell` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
...
INSERT INTO `company` (`ID_Company`, `Name_Company`, `Detail_address`, `ID_province`, `ID_amphur`, `ID_district`, `company_web`, `Tell`) VALUES
(1, 'ศูนย์สหกิจศึกษา', 'มหาวิทยาลัยราชภัฎรำไพพรรณี อาคาร36', 13, 160, 1268, 'http://www.coop.rbru.ac.th/', '039319111\r'),
(2, 'บริษัท คิง เพาเวอร์ อินเตอร์เนชั่นแนล', '999 ตำบลหนองปรือ อำเภอบางพลี จ.สมุทรปราการ 10540', 2, 54, 277, '', ''),
(3, 'บริษัท เครื่องดื่มกระทิงแดง จำกัด', '288 ถนนเอกชัย แขวงบางบอน เขตบางบอน กรุงเทพมหานคร 10150', 1, 50, 236, '', ' 024150100'),
(4, 'บริษัท ซาโนฟี่ ปาสเตอร์ จำกัด', '87/2 อาคาร CRC TOWER ชั้น 23 ออลซีซันเพลส ถนนวิทยุ แขวงลุมพินี เขตปทุมวัน กรุงเทพมหานคร', 1, 7, 54, '', ' 022649999'),
(5, 'บริษัท ไทยซัมซุงอิเลคโทรนิค จำกัด', '195 อาคารเอ็มไพร์ทาวเวอร์ ชั้น 19 ถนนสาทรใต้ แขวงยานนาวา เขตสาทร กรุงเทพมหานคร ', 1, 28, 176, '', '026959000\r');
...
CREATE TABLE `department` (
  ...
  `name_department` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `id_faculty_pk` int(11) DEFAULT '0'
...
INSERT INTO `department` (`id_department`, `name_department`, `id_faculty_pk`) VALUES
(1, 'สาขาวิชาเทคโนโลยีสารสนเทศ', 1),
(2, 'สาขาวิชาภูมิสารสนเทศ', 1),
(3, 'สาขาวิชาวิทยาการคอมพิวเตอร์', 1),
(4, 'สาขาวิชาเทคโนโลยีเครือข่ายคอมพิวเตอร์', 1),
(5, 'สาขาวิชาเคมี', 2),
(6, 'สาขาวิชาคหกรรมศาสตร์', 2),
(7, 'สาขาวิชาจุลชีววิทยา', 2),
(8, 'สาขาวิชาชีววิทยา', 2),
(9, 'สาขาวิชาวิทยาศาสตรสิ่งแวดล้อม', 2),
(10, 'สาขาวิชาสถิติประยุกต์', 2),
(11, 'สาขาวิชาการศึกษาปฐมวัย', 3),
(12, 'สาขาวิชาการศึกษาพิเศษ', 3),
(13, 'สาขาวิชาสังคมศึกษา', 3),
(14, 'สาขาวิชาวิทยาศาสตร์', 3),
(15, 'สาขาวิชาภาษาไทย', 3),
(16, 'สาขาวิชาอังกฤษ', 3),
(17, 'สาขาวิชาพลศึกษา', 3),
(18, 'สาขาวิชาคณิตศาสตร์', 3),
(19, 'สาขาคอมพิวเตอร์ศึกษา', 3),
(20, 'สาขาวิชาการปกครองท้องถิ่น', 3),
(21, 'สาขาวิชาการพัฒนาชุมชน', 4),
(22, 'สาขาวิชาดนตรี', 4),
(23, 'สาขาวิชาภาษาจีน', 4),
(24, 'สาขาวิชาภาษาอังกฤษธุรกิจ', 4),
(25, 'สาขาวิชาภาษาไทย', 4),
(26, 'สาขาวิชารัฐประศาสนศาสตร์', 4),
(27, 'สาขาวิชารัฐศาสตร์', 4),
(28, 'สาขาวิชาศิลปกรรม', 4);

-- --------------------------------------------------------

--
-- Table structure for table `detail_position`
--

CREATE TABLE `detail_position` (
  `ID_detail_position` int(11) NOT NULL COMMENT 'รหัสใบประกาศตำแหน่งงาน',
  `ID_company` int(11) NOT NULL COMMENT 'ชื่อสถานประกอบการ',
  `ID_ttl_position` int(11) NOT NULL COMMENT 'งานด้าน',
  `name_position` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'ชื่อตำแหน่งงาน',
  `Num_student` int(11) NOT NULL COMMENT 'จำนวนที่เปิดรับ',
  `time` date DEFAULT NULL COMMENT 'รับช่วงเดือน',
  `ID_fac` int(11) NOT NULL COMMENT 'รับสาขาวิชา',
  `Detail` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'ลายละเอียดอื่นๆ'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `detail_position`
--

INSERT INTO `detail_position` (`ID_detail_position`, `ID_company`, `ID_ttl_position`, `name_position`, `Num_student`, `time`, `ID_fac`, `Detail`) VALUES
(1, 1, 6, 'เจ้าหน้าที่ IT Support', 1, '2016-10-27', 1, 'มีความรู้ความเข้าใจในระบบ Hardware และ Software ที่ใช้ในสำนักงาน'),
(2, 4, 7, 'เจ้าหน้าวิจัยและพัฒนาผลิตภัณฑ์', 2, '2016-10-29', 9, 'ชาย – หญิง อายุไม่เกิน 30 ปี\r\nการศึกษา ปริญญาตรี-โท สาขาบรรจุภัณฑ์, พอลิเมอร์, วัสดุศาสตร์\r\nมีประสบการณ์ด้านการขึ้นรูปพลาสติกแบบเทอร์โมฟอร์ม\r\nสามารถปฏิบัติงานในพื้นที่จังหวัดระยองได้'),
(3, 2, 10, 'พนักงานคลังสินค้า', 2, '2016-10-26', 6, 'ควบคุมการเบิก - จ่ายวัสดุต่างๆ ที่เกี่ยวข้อง\r\nทำรายงานการเบิก - จ่ายสิ่งของต่างๆ\r\nตรวจเช็ควัสดุอุปกรณ์ให้ครบตามจำนวน\r\nดูแลพื้นที่จัดเก็บสินค้าให้มีความเรียบร้อยและสะอาดอยู่เสมอ\r\nงานอื่นๆ ที่ได้รับมอบหมายจากผู้บังคับบัญชา'),
(4, 5, 6, 'Programmer', 2, '2016-10-28', 1, 'Yii2 CSS HTML5 BS');
...
--
-- Table structure for table `doc_01`
--

CREATE TABLE `doc_01` (
  `Id_doc_01` int(11) NOT NULL,
  `title_name_th_id` int(11) NOT NULL COMMENT 'คำนำหน้าชื่อไทย',
  `Fname_th` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'ชื่อจริง',
  `Lname_th` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'นามสกุล',
  `Num_student` varchar(10) COLLATE utf8_bin NOT NULL COMMENT 'รหัสนักศึกษา',
  `title_name_en_id` int(11) NOT NULL COMMENT 'คำนำหน้าชื่ออังกฤษ',
  `Fname_en` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'ชื่อจริงอังกฤษ',
  `Lname_en` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'นามสกุลอังกฤษ',
  `year_in_school_id_year` int(11) NOT NULL COMMENT 'ชั้นปี',
  `faculty_id_faculty` int(11) NOT NULL COMMENT 'คณะ',
  `department_id_department` int(11) NOT NULL COMMENT 'สาขาวิชา',
  `credit` int(3) NOT NULL COMMENT 'จำนวนหน่วยกิจปัจจุบัน',
  `GPA` double NOT NULL COMMENT 'เกรดเฉลี่ย',
  `semester_Id_semester` int(11) NOT NULL COMMENT 'ภาคการศึกษา',
  `year_Id_year` int(11) NOT NULL COMMENT 'ปีการศึกษา',
  `province_PROVINCE_ID` int(11) NOT NULL COMMENT 'จังหวัด',
  `amphur_AMPHUR_ID` int(11) NOT NULL COMMENT 'อำเภอ',
  `district_DISTRICT_ID` int(11) NOT NULL COMMENT 'ตำบล',
  `Detail_address` varchar(500) COLLATE utf8_bin NOT NULL COMMENT 'ลายละเอียดที่อยู่',
  `Cell_phone_num` varchar(10) COLLATE utf8_bin NOT NULL COMMENT 'เบอร์มือถือ',
  `Phone_num` varchar(10) COLLATE utf8_bin DEFAULT NULL COMMENT 'เบอร์โทรศัพท์บ้าน',
  `Email` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'Eamil',
  `province_PROVINCE_ID1` int(11) DEFAULT NULL COMMENT 'จังหวัด',
  `amphur_AMPHUR_ID1` int(11) DEFAULT NULL COMMENT 'อำเภอ ',
  `district_DISTRICT_ID1` int(11) DEFAULT NULL COMMENT 'ตำบล',
  `Detail_address2` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT 'ลายละเอียดที่อยู่',
  `title_name_th_id_title_name_th` int(11) NOT NULL COMMENT 'คำนำหน่าชื่อ',
  `Fname_th2` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'ชื่อจริง',
  `Lname_th2` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'นามสกุล',
  `Relation` varchar(50) COLLATE utf8_bin NOT NULL COMMENT 'ความสัมพันธ์',
  `Cell_phone_num3` varchar(11) COLLATE utf8_bin NOT NULL COMMENT 'เบอร์โทรผู้ปกครอง',
  `Talent` varchar(200) COLLATE utf8_bin NOT NULL COMMENT 'ความสามารถพิเศษหรือกิจกรรมของนักศึกษา',
  `skillpoint_en` int(11) NOT NULL COMMENT 'ความสามารถทางด้านภาษาอังกฤษ',
  `skillpoint_jp` int(11) NOT NULL COMMENT 'ความสามารถทางด้านภาษาญี่ปุ่น',
  `skillpoint_cn` int(11) NOT NULL COMMENT 'ความสามารถทางด้านภาษาจีน',
  `geo_interested` int(11) NOT NULL COMMENT 'ภูมิภาคทีนักศึกษาสนใจฝึกงาน',
  `in_position_id` int(11) NOT NULL COMMENT 'ลักษณะงานที่สนใจ',
  `Interest_academic` varchar(500) COLLATE utf8_bin NOT NULL COMMENT 'ความสนใจทางด้านวิชาการ',
  `created_by` int(11) DEFAULT NULL COMMENT 'กรอกโดย',
  `updated_by` int(11) DEFAULT NULL COMMENT 'แก้โดย',
  `created_at` int(11) DEFAULT NULL COMMENT 'กรอกเมื่อ',
  `updated_at` int(11) DEFAULT NULL COMMENT 'แก้เมือ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Dumping data for table `doc_01`
--

INSERT INTO `doc_01` (`Id_doc_01`, `title_name_th_id`, `Fname_th`, `Lname_th`, `Num_student`, `title_name_en_id`, `Fname_en`, `Lname_en`, `year_in_school_id_year`, `faculty_id_faculty`, `department_id_department`, `credit`, `GPA`, `semester_Id_semester`, `year_Id_year`, `province_PROVINCE_ID`, `amphur_AMPHUR_ID`, `district_DISTRICT_ID`, `Detail_address`, `Cell_phone_num`, `Phone_num`, `Email`, `province_PROVINCE_ID1`, `amphur_AMPHUR_ID1`, `district_DISTRICT_ID1`, `Detail_address2`, `title_name_th_id_title_name_th`, `Fname_th2`, `Lname_th2`, `Relation`, `Cell_phone_num3`, `Talent`, `skillpoint_en`, `skillpoint_jp`, `skillpoint_cn`, `geo_interested`, `in_position_id`, `Interest_academic`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(2, 1, 'ฤทธิชัย', 'จตุรภาค', '5614421013', 1, 'Ritichai', 'Jaturapak', 4, 1, 1, 120, 3.33, 1, 5, 13, 160, 1268, '8/12 ม.4', '0827260183', '3333333333', 'kewkew5588@gmail.com', 13, 160, 1268, '8/12 ม.4', 2, 'ปราณี', 'จตุรภาค', 'แม่', '3333333333', '.', 2, 2, 2, 5, 6, 'ชอบศึกษาและออกแบบ web', NULL, 2, 1477453195, 1478445355),
(3, 1, 'ปริญญา', 'เบี้ยแก้ว', '5614421010', 1, 'Parinya', 'Beakeay', 4, 4, 21, 120, 3.33, 2, 5, 13, 162, 1288, '', '0899092583', '', 'BewBew5588@gmail.com', 3, 60, 321, '', 1, 'สมมาตร', 'จตุรภาค', 'พ่อ', '0899092583', 'SQL', 2, 2, 2, 4, 2, 'SQL', NULL, 3, 1477593576, 1477593667),
(4, 1, 'ปริญญา', 'เบี้ยแก้ว', '5987654321', 1, 'Parinya', 'Beakaew', 4, 1, 1, 180, 1.93, 2, 5, 13, 164, 1328, '59/1 ม.3 ต.ปัถวี อ.มะขาม 22150', '0970079938', '', 'parin2558@gmail.com', 13, 169, 1362, '110/1 ', 2, 'พิชญา', 'เบี้ยแก้ว', 'แม่', '0817621331', 'เล่น DOTA', 2, 4, 2, 5, 3, 'คอมพิวเตอร์', NULL, 4, 1478446454, 1478446454);
...
CREATE TABLE `faculty` (
  ...
  `name_faculty` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(7, 'คณะนิติศาสตร์'),
(8, 'คณะนิเทศศาสตร์'),
(9, 'คณะอัญมณีศาสตร์และประยุกต์ศิลป์'),
(10, 'เทคโนโลยีการเกษตร');

-- --------------------------------------------------------

--
-- Table structure for table `in_position`
--

CREATE TABLE `in_position` (
  `id_in_position` int(11) NOT NULL,
  `name_in_positioncol` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `in_position`
--

INSERT INTO `in_position` (`id_in_position`, `name_in_positioncol`) VALUES
(1, 'งานภาคสนาม'),
(2, 'งานวิจัย'),
(3, 'งานห้องปฏิบัติงาน'),
(4, 'งานการตลาด'),
...
('m000000_000000_base', 1469685547),
('m130524_201442_init', 1469685553),
('m140209_132017_init', 1469687934),
('m140403_174025_create_account_table', 1469687935),
('m140504_113157_update_tables', 1469687939),
('m140504_130429_create_token_table', 1469687941),
('m140506_102106_rbac_init', 1469688499),
('m140602_111327_create_menu_table', 1469688469),
('m140830_171933_fix_ip_field', 1469687942),
('m140830_172703_change_account_table_name', 1469687942),
('m141222_110026_update_ip_field', 1469687942),
('m141222_135246_alter_username_length', 1469687943),
('m150614_103145_update_social_account_table', 1469687945),
('m150623_212711_fix_username_notnull', 1469687946),
('m160312_050000_create_user', 1469688469);
...
CREATE TABLE `skillpoint` (
  `id_skillpoint` int(11) NOT NULL,
  `skillpoint` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `skillpoint`
--

INSERT INTO `skillpoint` (`id_skillpoint`, `skillpoint`) VALUES
(2, 'พอใช้'),
(3, 'ปานกลาง'),
(4, 'ดี');
...
--
-- Table structure for table `sub_position`
--

CREATE TABLE `sub_position` (
  `ID_sub` int(11) NOT NULL COMMENT 'รหัสใบเลือกตำแหน่งงาน',
  `created_by` int(11) NOT NULL COMMENT 'เลือกโดย',
  `updated_by` int(11) NOT NULL COMMENT 'แก้โดย',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'เลือกเมื่อ',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'แก้เมื่อ',
  `status` enum('รอการอนุมัติ','ได้รับการอนุมัติ') COLLATE utf8_bin NOT NULL DEFAULT 'รอการอนุมัติ',
  `ID_detail_positions` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Dumping data for table `sub_position`
--

INSERT INTO `sub_position` (`ID_sub`, `created_by`, `updated_by`, `created_at`, `updated_at`, `status`, `ID_detail_positions`) VALUES
(2, 2, 1, '2016-10-28 01:57:27', '0000-00-00 00:00:00', 'ได้รับการอนุมัติ', 1),
(3, 3, 3, '2016-10-28 01:42:52', '2016-10-27 18:42:52', 'รอการอนุมัติ', 3),
(4, 2, 2, '2016-11-02 15:26:41', '2016-11-02 08:26:41', 'รอการอนุมัติ', 4),
(5, 4, 1, '2016-11-06 22:38:54', '0000-00-00 00:00:00', 'ได้รับการอนุมัติ', 4);
...
INSERT INTO `tbl_geography` (`GEO_ID`, `GEO_NAME`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `title_name_en`
--

CREATE TABLE `title_name_en` (
  `id_title_name_en` int(1) NOT NULL,
  `nametitle_name_en` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `title_name_en`
--

INSERT INTO `title_name_en` (`id_title_name_en`, `nametitle_name_en`) VALUES
(1, 'Mr'),
(2, 'Mrs'),
(3, 'Miss');
...
--
-- Table structure for table `title_name_th`
--

CREATE TABLE `title_name_th` (
  `id_title_name_th` int(1) NOT NULL,
  `name_title_name_th` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `title_name_th`
--

INSERT INTO `title_name_th` (`id_title_name_th`, `name_title_name_th`) VALUES
(1, 'นาย'),
(2, 'นาง'),
(3, 'นางสาว');
...
--
-- Table structure for table `title_position`
--

CREATE TABLE `title_position` (
  `idtitle_position` int(11) NOT NULL,
  `title_positioncol` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `title_position`
--

INSERT INTO `title_position` (`idtitle_position`, `title_positioncol`) VALUES
(6, 'งานด้าน ไอที'),
(7, 'งานการผลิด'),
(8, 'งานบัญชี'),
(9, 'งานวิศวกรรม'),
...
(1, 'supervisor', 'coop@rbru.ac.th', '$2y$13$un4bXIz8ghdeYobbnn5BROxp12Jw6B8L.D7tcAkKdksa0IEn9MSLa', 'lpQAd8OIjrZzVxV7Cmz0DKYjaWnS_9DM', NULL, NULL, NULL, NULL, 1471265563, 1477383839, 0, 10),
(2, '5614421013', 'kewkew5588@gmail.com', '$2y$13$KesqiyNhFEhWLqw9czbUFuEo46Dwy/Q1JmdJYG7n.aJWkQqQv9UCO', 'u26_PjJmobeQsr-p1EvS8shLOu24I8sF', NULL, NULL, NULL, NULL, 1477383888, 1477384488, 0, 10),
(3, '5614421010', 'club_yeng@htomail.com', '$2y$13$NvzK4We8DPwhdfRBvSjuneOVY0YNFXo3YEgep6BzDDiFl4vrcnCmS', '7HdSADvsIbDT9UMFc6jJnYZQ0h0hO19F', NULL, NULL, NULL, NULL, 1477384408, 1477550280, 0, 10),
(4, '5987654321', 'parin2558@gmail.com', '$2y$13$T5ZsnC/mnOHXzGFF9jC0bun0e0MUnOEIse7MEzYzN7NR.gLLUt8H.', 'fFsY_5pfaOgXdPlZCKDQPYY--4Kc9mWr', NULL, NULL, NULL, NULL, 1478445926, 1478445961, 0, 10);
...
INSERT INTO `year` (`Id_year`, `Num_year`) VALUES
(1, 2555),
(2, 2556),
(3, 2557),
(4, 2558),
...
--
-- Table structure for table `year_in_school`
--

CREATE TABLE `year_in_school` (
  `id_year` int(11) NOT NULL,
  `num_year` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `year_in_school`
--

INSERT INTO `year_in_school` (`id_year`, `num_year`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4);
...
--
-- Indexes for table `detail_position`
--
ALTER TABLE `detail_position`
  ADD PRIMARY KEY (`ID_detail_position`);
...
--
-- Indexes for table `doc_01`
--
ALTER TABLE `doc_01`
  ADD PRIMARY KEY (`Id_doc_01`);
...
--
-- Indexes for table `in_position`
--
ALTER TABLE `in_position`
  ADD PRIMARY KEY (`id_in_position`);
...
ALTER TABLE `skillpoint`
  ADD PRIMARY KEY (`id_skillpoint`);

--
-- Indexes for table `sub_company`
--
ALTER TABLE `sub_company`
  ADD PRIMARY KEY (`created_by`);

--
-- Indexes for table `sub_position`
--
ALTER TABLE `sub_position`
  ADD PRIMARY KEY (`ID_sub`);

--
-- Indexes for table `tbl_geography`
--
ALTER TABLE `tbl_geography`
  ADD PRIMARY KEY (`GEO_ID`);

--
-- Indexes for table `title_name_en`
--
ALTER TABLE `title_name_en`
  ADD PRIMARY KEY (`id_title_name_en`);

--
-- Indexes for table `title_name_th`
--
ALTER TABLE `title_name_th`
  ADD PRIMARY KEY (`id_title_name_th`);

--
-- Indexes for table `title_position`
--
ALTER TABLE `title_position`
  ADD PRIMARY KEY (`idtitle_position`);
...
--
-- Indexes for table `year_in_school`
--
ALTER TABLE `year_in_school`
  ADD PRIMARY KEY (`id_year`);
...
--
ALTER TABLE `department`
  MODIFY `id_department` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
-- AUTO_INCREMENT for table `detail_position`
--
ALTER TABLE `detail_position`
  MODIFY `ID_detail_position` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสใบประกาศตำแหน่งงาน', AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT for table `in_position`
--
ALTER TABLE `in_position`
  MODIFY `id_in_position` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `skillpoint`
  MODIFY `id_skillpoint` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `sub_position`
--
ALTER TABLE `sub_position`
  MODIFY `ID_sub` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสใบเลือกตำแหน่งงาน', AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tbl_geography`
--
ALTER TABLE `tbl_geography`
  MODIFY `GEO_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `title_name_en`
--
ALTER TABLE `title_name_en`
  MODIFY `id_title_name_en` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `title_name_th`
--
ALTER TABLE `title_name_th`
  MODIFY `id_title_name_th` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `title_position`
--
ALTER TABLE `title_position`
  MODIFY `idtitle_position` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `year`
  MODIFY `Id_year` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `year_in_school`
--
ALTER TABLE `year_in_school`
